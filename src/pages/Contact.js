...
export default function ContactScreen() {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl mx-auto py-10 px-4 sm:px-8 md:px-14 rounded-2xl pb-6"
        style={{
      ...
      >
        ...
        {submitted ? (
          ...
          >
            <label
              className="flex flex-col text-base sm:text-lg font-medium"
            ...
            >
              ...
              <input
                ...
                style={{
                  ...
                  border: "1.5px solid " + COLORS.light.secondary,
            ...
            {error && (
              <div className="text-red-600 text-center font-medium mb-2">
                {error}
              </div>
            )}
            <button
              ...
              style={{
                ...
                minHeight: 48,
                boxShadow: "0 2px 8px 0 " + COLORS.light.primary + "33",
                marginBottom: 8,
              }}
              disabled={loading}
            >
